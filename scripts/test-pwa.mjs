...
console.log('PWA smoke test passed: manifest, installation metadata, service-worker registration, versioning, activation, cleanup, and offline fallback are present.')
